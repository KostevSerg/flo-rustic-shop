...
const Contacts = () => {
  ...
  const { title: pageTitle, description: pageDescription, cityInPrepositional } = useCitySEO(
    'Контакты',
    `Контакты FloRustic: телефон для заказа цветов, адреса салонов, email поддержки. Работаем 24/7 без выходных. Консультация флориста бесплатно. Оперативные ответы на все вопросы о доставке букетов!`
  );
