...
const Index = () => {
  ...
  const pageDescription = selectedCity
    ...
    : 'Доставка свежих цветов по России: более 200 городов. Букеты на любой повод, стабилизированный мох, композиции ручной работы. Быстрая доставка, свежие цветы от флористов. Заказать онлайн!';
