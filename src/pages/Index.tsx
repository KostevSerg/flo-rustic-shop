...
const Index = () => {
  ...
  const pageDescription = selectedCity
    ? `Свежие цветы и букеты с доставкой в ${selectedCity} от FloRustic. Розы, тюльпаны, композиции ручной работы. Доставка за 2 часа. Гарантия свежести. Заказ онлайн 24/7. Более 500 букетов в каталоге!`
    : 'Доставка цветов по России от FloRustic — более 200 городов. Свежие букеты ручной работы, розы, тюльпаны, стабилизированный мох. Быстрая доставка за 2 часа. Гарантия качества. Заказ онлайн 24/7!';
