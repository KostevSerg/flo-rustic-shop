      ...
      <section className="bg-card rounded-lg p-8 border">
        ...
        <div className="space-y-4 text-muted-foreground">
          ...
          <p>
            ...
            Мы работаем только со свежими цветами от проверенных поставщиков и гарантируем качество каждого букета. 
          ...
          <p>
            ...
            Доставка работает ежедневно, включая выходные и праздничные дни.
          </p>
        </div>
      </section>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground text-sm">
                  Доставим букет в {cityPrepositional} в течении 1.5 часов. Работаем ежедневно, включая выходные и праздники.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-card rounded-lg p-6 border">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground text-sm">
                  Принимаем оплату онлаин или перевод на реквизиты предоставленные оператором.
                </p>
              </div>
            </div>
          </div>
